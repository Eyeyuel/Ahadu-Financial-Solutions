...
export const FounderSection: React.FC = () => {
  ...
  return (
    <section className="py-20 md:py-28 bg-[#0B1B3A] text-white relative overflow-hidden">
      {/* Background Accent */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#F2B84B]/10 blur-3xl rounded-full pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Founder's Statement Card */}
        <div className="bg-[#071228] border border-[#F2B84B]/30 rounded-3xl p-8 sm:p-12 shadow-2xl mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1FA971]/15 text-[#34D399] border border-[#1FA971]/30 text-xs font-semibold">
                <Quote className="w-3.5 h-3.5 text-[#F2B84B]" />
                <span>Founder's Message</span>
              </div>

              <blockquote className="text-lg sm:text-xl text-slate-100 font-light leading-relaxed italic">
                “I founded Ahadu Financial Solutions with a simple but meaningful purpose: to help businesses build stronger financial foundations and make informed decisions that support sustainable growth. The name <strong className="text-[#F2B84B] font-semibold">‘Ahadu’</strong>, meaning <strong className="text-[#34D399] font-semibold">‘One’ or ‘Unity’ in Amharic</strong>, reflects the philosophy upon which our company is built. We believe that the strongest results are achieved through partnership, trust, and shared success.”
              </blockquote>

              <div>
                <div className="text-lg font-bold text-white">Arsema Habtamu</div>
                <div className="text-xs text-[#F2B84B] font-medium tracking-wider uppercase">
            ...
            <div className="lg:col-span-4 bg-white/5 border border-white/10 p-6 rounded-2xl space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2 border-t border-white/10">
                  <div className="text-xs font-bold text-white uppercase tracking-wider">Mission</div>
                  <p className="text-xs text-slate-300 mt-1 leading-relaxed">
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {values.map((v, i) => {
              const Icon = v.icon;
              return (
                <div key={i} className="p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-[#1FA971]/50 transition-all space-y-3">
