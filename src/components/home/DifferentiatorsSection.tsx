      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-12 border-b border-slate-200 text-sm font-bold">
            ...
            <div className="md:col-span-4 p-5 bg-slate-100 text-slate-600 uppercase tracking-wider text-xs border-t md:border-t-0 md:border-l border-slate-200 flex items-center gap-2">
          ...
          <div className="divide-y divide-slate-100">
            {comparisons.map((item, idx) => (
              <div key={idx} className="grid grid-cols-1 md:grid-cols-12 text-xs sm:text-sm hover:bg-slate-50/80 transition-colors">
                ...
                {/* Standard */}
                <div className="md:col-span-4 p-5 text-slate-600 flex items-center gap-2 md:border-l border-slate-100">
