      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.12] text-white max-w-2xl">
            ...
            <blockquote className="pl-4 border-l-2 border-[#1FA971] text-sm text-slate-300 italic max-w-lg">
          ...
          <div className="lg:col-span-5">
            <div className="relative bg-[#071228] border border-[#F2B84B]/30 rounded-2xl p-6 shadow-2xl overflow-hidden backdrop-blur-xl">
              {/* Card Header */}
              ...
              <div className="grid grid-cols-3 gap-1 p-1 bg-white/5 rounded-lg mb-6 text-xs font-medium">
                <button
                  ...
                  className={`py-2 rounded-md transition-all ${
                    activeTab === 'visibility' ? 'bg-[#1FA971] text-white font-semibold shadow-md' : 'text-slate-400 hover:text-white'
                  }`}
                >
                  Reporting
                </button>
                <button
                  ...
                  className={`py-2 rounded-md transition-all ${
                    activeTab === 'tax' ? 'bg-[#1FA971] text-white font-semibold shadow-md' : 'text-slate-400 hover:text-white'
                  }`}
                >
                  Tax Support
                </button>
                <button
                  ...
                  className={`py-2 rounded-md transition-all ${
                    activeTab === 'cashflow' ? 'bg-[#1FA971] text-white font-semibold shadow-md' : 'text-slate-400 hover:text-white'
                  }`}
                >
                  Cash Flow
                </button>
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10 space-y-2">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-300">Monthly Statement Readiness</span>
                ...
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10 space-y-3">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="px-2 py-0.5 rounded bg-[#1FA971]/20 text-[#34D399] font-mono text-[11px] font-bold">
                        OPTIMAL (LOW RISK)
                      </span>
                    </div>
              ...
              {activeTab === 'cashflow' && (
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10 space-y-3">
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-slate-300">90-Day Liquidity Forecast</span>
